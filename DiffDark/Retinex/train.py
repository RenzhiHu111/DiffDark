...
def train(model):
    ...
    # LOL dataset
    train_low_data_names = glob(args.data_dir + '/data/train/low/*.png')

    train_high_data_names = glob(args.data_dir + '/data/train/high/*.png')

    eval_low_data_names = glob(args.data_dir + '/test/low/*.*')
