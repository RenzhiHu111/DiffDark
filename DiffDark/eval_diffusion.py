...
def parse_args_and_config():
    parser = argparse.ArgumentParser(description='Enhancing Low-Light Images with Patch-Based Denoising Diffusion Models(LOL)')
    parser.add_argument("--config", type=str, default='lol.yml',
                        help="Path to the config file")
    parser.add_argument('--resume', default='./ckpts/lol_ddpm.pth.tar', type=str,
    ...
    parser.add_argument("--test_set", type=str, default='',
                        help="restoration test set options: ['lol']")
    parser.add_argument("--image_folder", default='results/images_lol/', type=str,
